...
exports.getConversations = async (req, res) => {
  try {
    ...
    console.log("Sending formatted conversations:", formattedConversations.length)
...
exports.getMessages = async (req, res) => {
  try {
    ...
    // Format messages with profile photos
...
// Update the sendMessage function to check if the conversation is blocked
exports.sendMessage = async (req, res) => {
  try {
    ...
    if (conversation.isArchived && conversation.archivedBy.toString() === senderId.toString()) {
